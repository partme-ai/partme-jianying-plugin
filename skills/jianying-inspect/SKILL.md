...
description: "Inspect materials and drafts before/after generation: ffprobe measured durations, draft JSON structure read-back, and the built-in jianying-cli verify/inspect as lint tooling. Read-only."
license: Apache-2.0
---
...
`jianying probe <media>`（承载插件的 vendored 快照构建产物，同源 ffprobe）。
